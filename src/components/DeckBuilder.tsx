...
const DeckBuilder = () => {
  ...
  const groupedCardsByType = activeDeck
          ...
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                {activeDeck.format} • {activeDeck.cards.length} cards
              </p>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Card>
                  ...
                  <CardContent>
                    <div className="h-[100px] flex items-end justify-around">
                      {/* Simple bar chart for mana curve */}
                ...
                <Card>
                  ...
                  <CardContent className="flex flex-wrap gap-2">
                    {Array.from(
                      new Set(activeDeck.cards.map((c) => c.rarity))
                    ).map((rarity) => (
                      <Badge key={rarity} variant="outline" className="capitalize">
                        {rarity}:{" "}
                        {
                          activeDeck.cards.filter((c) => c.rarity === rarity)
                            .length
                        }
                      </Badge>
                    ))}
